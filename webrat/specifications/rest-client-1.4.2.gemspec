...
Gem::Specification.new do |s|
  ...
  s.test_files = ["spec/base.rb", "spec/exceptions_spec.rb", "spec/integration_spec.rb", "spec/abstract_response_spec.rb", "spec/payload_spec.rb", "spec/raw_response_spec.rb", "spec/request_spec.rb", "spec/resource_spec.rb", "spec/response_spec.rb", "spec/restclient_spec.rb"]
